...
fish_add_path -U "$N_PREFIX/bin"
fish_add_path -U "$HOME/Library/Application\ Support/JetBrains/Toolbox/scripts"
fish_add_path -U "$HOME/.composer/vendor/bin"
fish_add_path -U "$HOME/Sites/packages/project-content-sync"
fish_add_path -U "$HOME/Library/Preferences/netlify/helper/bin"
