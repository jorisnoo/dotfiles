...
# NPM
alias nw='yarn run watch'
alias np='yarn run prod'
alias nd='yarn run dev'
alias nb='yarn run build'
alias ng='yarn run generate'
alias nh='yarn run hot'
alias nl='yarn run lint'
alias nlf='yarn run lintfix'
alias yw='yarn run watch'
alias yp='yarn run prod'
alias yd='yarn run dev'
alias yb='yarn run build'
alias yg='yarn run generate'
alias yh='yarn run hot'
alias yl='yarn run lint'
alias ylf='yarn run lintfix'
